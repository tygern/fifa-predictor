...
describe Simulator do
  it "play" do
    ...
    match_results = [
      MatchResult.new(home_team: scores_a_lot, home_goals: 90, home_red_cards: 0, away_team: not_so_good, away_goals: 0, away_red_cards: 0, duration: 90),
      MatchResult.new(home_team: lots_of_reds, home_goals: 0, home_red_cards: 90, away_team: scores_a_lot, away_goals: 90, away_red_cards: 0, duration: 90),
    ]
